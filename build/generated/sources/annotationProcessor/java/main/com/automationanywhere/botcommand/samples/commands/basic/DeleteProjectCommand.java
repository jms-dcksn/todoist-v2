...
public final class DeleteProjectCommand implements BotCommand {
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    try {
      command.action((String)convertedParameters.get("sessionName"),(String)convertedParameters.get("projectId"));Optional<Value> result = Optional.empty();
