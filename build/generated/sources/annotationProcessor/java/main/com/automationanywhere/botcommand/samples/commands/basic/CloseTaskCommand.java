...
public final class CloseTaskCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(CloseTaskCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    CloseTask command = new CloseTask();
    ...
    try {
      command.action((String)convertedParameters.get("sessionName"),(String)convertedParameters.get("taskId"));Optional<Value> result = Optional.empty();
